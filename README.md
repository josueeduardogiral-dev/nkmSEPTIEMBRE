...
- Exportación a Excel:
  - Reporte de cualquier mes de 2026 seleccionado por el administrador, con una hoja por empleado y todas las semanas laborales completas del mes (`/login/descargar/asistencia`).
